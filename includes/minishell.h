...
/*   Updated: 2024/11/03 16:47:55 by aamirkha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					eval_dfs(t_ast_node *root, t_ast *ast,
...
int					ast_handle_pipe(t_ast_node *root, t_ast *ast,
						t_authorized_fds fds);
int					ast_handle_cmd(t_ast_node *root);
int					ast_prehandle_cmd(t_ast_node *root, t_ast *ast,
						t_authorized_fds fds);
